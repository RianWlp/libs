...
VALUES
('Workshop de Inteligência Artificial', 'Um workshop sobre os fundamentos de IA e Machine Learning.', '2024-12-01 09:00:00', '2024-12-01 17:00:00', 100, '01245', 100),
('Seminário de Tecnologia', 'Discussões sobre tendências tecnológicas no mercado.', '2024-12-05 10:00:00', '2024-12-05 15:00:00', 200, '012466', 10),
('Hackathon 2024', 'Maratona de programação com premiação para as melhores soluções.', '2024-12-10 08:00:00', '2024-12-11 20:00:00', 50, '0124315', 4),
('Congresso de Ciências', 'Evento acadêmico para apresentação de pesquisas científicas.', '2025-01-15 09:00:00', '2025-01-17 18:00:00', 300, '0124316', 9),
('Palestra de Empreendedorismo', 'Inspirando novos empreendedores com histórias de sucesso.', '2024-11-20 14:00:00', '2024-11-20 16:00:00', 150, '000124', 11),
('Curso de Desenvolvimento Web', 'Curso introdutório de HTML, CSS e JavaScript.', '2024-12-03 09:00:00', '2024-12-03 17:00:00', 75, '110124', 5),
('Oficina de Design Gráfico', 'Aprenda os fundamentos do design e ferramentas gráficas.', '2024-12-07 10:00:00', '2024-12-07 16:00:00', 40, '220124', 20),
('Encontro de Robótica', 'Demonstrações e palestras sobre robótica e automação.', '2024-11-25 08:00:00', '2024-11-25 14:00:00', 60, '3330124', 200);
...
INSERT INTO presencas (fk_inscricao, presenca_confirmada)
VALUES
(1, TRUE),
(2, FALSE),
(3, TRUE),
...
INSERT INTO certificados (fk_inscricao, fk_usuario, fk_evento, url_validacao, codigo_autenticacao)
VALUES
